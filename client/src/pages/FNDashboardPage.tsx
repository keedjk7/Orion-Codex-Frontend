...
// Lazy load FN Dashboard component
const FNDashboard = React.lazy(() => import('./FNDashboard'));

export default function FNDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className={cn(
        ...
        <DashboardHeader
          title="FN Dashboard"
          subtitle="Financial dashboard with comprehensive business intelligence"
          ...
          <Suspense fallback={
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                ...
                <p className="text-gray-600">Loading FN Dashboard...</p>
              </div>
            </div>
          }>
            <FNDashboard />
